# BaseView JWT Token Auth functions
import jwt
...
from apps.users.models import Users, UsersSchema
from werkzeug.security import check_password_hash, generate_password_hash
from sqlalchemy.exc import SQLAlchemyError
from marshmallow import ValidationError
from apps.basemodels import db
...
def parse_token(req):
    ...
    return jwt.decode(token, SECRET_KEY, algorithms='HS256')  # 使用默认加密算法

# login装饰器,需先校验headers
...
# Login Authentication Resourceful Routing Class
